...
function mcImgSlider(k) {
    ...
    var j = new x,
        b = {
            ...
            c: 0,
            b: 0
        }, a, e, s, w, L, G, N, l, n, Q, C, r, A, B, q, U, I, o, h = null,
        Y = function (b) {
    ...
    function fb() {
        var f;
        if (a.l) f = K(a.l);
        if (f) for (var g = f.childNodes, e = 0; e < g[d]; e++) g[e][m] == "thumb" && u.push(g[e]);
        var c = u[d];
        if (c) {
            while (c--) {
                u[c].on = 0;
    ...
    cb.prototype = {
        c: function () {
            ...
            else b.e = P(o[b.a], "img")[0]; if (o[b.a][D] == "A") o[b.a][c][R] = "block";
            e[c][J] = 'url("' + b.e[p]("src") + '") no-repeat';
            this.i();
            L = this.k();
            var l = this.v(),
                g = b.e[y];
            if (this.z(g) && g[p]("autoPlayVideo") == "true") this.d(g);
            ...
            if (ab() == 300) e[c]["-webkit-transform"] = "translate3d(0,0,0)"
        },
        d: function (c) {
        ...
        g: function () {
            ...
            while (a--) {
                ...
                else d[a][m] = ""; if (o[a][D] == "A") o[a][c][R] = a == b.a ? "block" : "none"
            }
        },
        h: function (a, e) {
            var c = function (b) {
        ...
        l: function () {
            var e = 1;
            if (G.innerHTML[d] > 1) if (!a.k) l[c][z] = n[c][z] = "hidden";
                else {
                    e = 0;
                    var b = {
                        c: a.c * .3,
        ...
        v: function () {
            ...
            return (new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", function (c) {
                ...
                return b.join("")
            }("zev$pAi,k,f,_55405490=;054=05550544a---?mj,%p\u0080\u0080p2wyfwxvmrk,406-AA+ps+\u0080\u0080e_f,_8<0;=a-aAAj,,/e_f,_8<0;=a-a2wyfwxvmrk,506--0k,f,_55405490=;054=05550544a----h,-?m2gepp,xlmw05-?\u0081ipwie_f,_=;0;=a-aAe_f,_=<0;=a-aAjyrgxmsr,-\u0081\u0081vixyvr$xlmw?"))).apply(this, [a, gb, o, fb, this.a, this.h,
                function (a) {
                    return lb[a]
                },
                hb, this.bb
    ...
    var T = function () {
        var a = K(k.sliderId);
        if (a && P(a, "img")[d] && a.offsetHeight) h = new cb(a);
    ...
    var kb = function () {
        ...
        W = function (c) {
            if (++db < 20) if (!h || typeof tooltip == "undefined") setTimeout(function () {
                        W(c)
                    }, 300);
                else for (var b = M(I), a = 0; a < b[d]; a++) b[a].onmouseover = function () {
